...
private:
    ...
    video::Sampler_Def::Semantic parse_semantic(std::string const& value, video::Sampler_Def::Semantic def) const;
    bool parse_bool(std::string const& val, bool def) const;
    bool parse_uniform_value(video::Uniform& u, std::string const& type, std::string const& count, std::string const& val) const;
    bool parse_uniform_min_value(video::Uniform& u, std::string const& type, std::string const& val) const;
    bool parse_uniform_max_value(video::Uniform& u, std::string const& type, std::string const& val) const;
    video::Render_State::Blend_Formula::Factor parse_blend_factor(std::string const& val, video::Render_State::Blend_Formula::Factor def) const;
};

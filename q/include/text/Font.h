...
// 		}
		...
		{
            void* library = nullptr;//FT_Library
            void* face = nullptr;//FT_Face
		} m_free_type_data;
		...
		struct Height_Data
		{
            uint32_t height = 0; //the height that this data caches

            float ascender = 0;
            float descender = 0;
            float font_height = 0; //returned by freetype
            float line_gap = 0;
        ...
        mutable uint32_t m_crt_height = 0;

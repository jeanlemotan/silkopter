...
public:
    ...
    Sampler_Def(std::string const& name, Sampler const& def);
    Sampler_Def(std::string const& name, std::string const& human_name, Sampler const& def);

    Sampler_Def(Sampler_Def const&) = default;
    Sampler_Def& operator=(Sampler_Def const& other) = default;

    std::string	get_human_name() const; //a pretty name to be displayed to the user, in an editor for example
    std::string	get_name() const; //the name to be used in the shader
...
inline Sampler_Def::Sampler_Def(std::string const& name, Sampler const& def)
    : m_name(name)
    , m_human_name(name)
    , m_default(def)
{
...
inline Sampler_Def::Sampler_Def(std::string const& name, std::string const& human_name, Sampler const& def)
    : m_name(name)
...
inline std::string Sampler_Def::get_name() const
{
    return m_name;
}
inline void Sampler_Def::set_name(std::string const& name)
{
    m_name = name;
}
inline std::string Sampler_Def::get_human_name() const
{
    return m_human_name;
}

...
public:
    ...
    Uniform_Def(std::string const& name,
                const Uniform& default_value, const Uniform& min_value, const Uniform& max_value);
    Uniform_Def(std::string const& name, std::string const& human_name,
                const Uniform& default_value, const Uniform& min_value, const Uniform& max_value);
    Uniform_Def(std::string const& name, std::string const& human_name);
    ...
    void			set_semantic(std::string const& semantic);
...
inline Uniform_Def::Uniform_Def(std::string const& name, const Uniform& default_value, const Uniform& min_value, const Uniform& max_value)
    : m_name(name)
    , m_human_name(name)
{
...
inline Uniform_Def::Uniform_Def(std::string const& name, std::string const& human_name, const Uniform& default_value, const Uniform& min_value, const Uniform& max_value)
    : m_name(name)
...
inline Uniform_Def::Uniform_Def(std::string const& name, std::string const& human_name)
    : m_name(name)
    , m_human_name(human_name)
{
    ;
...
inline std::string Uniform_Def::get_human_name() const
{
    return m_human_name;
}
inline std::string Uniform_Def::get_name() const
{
    return m_name;
}
inline void Uniform_Def::set_name(std::string const& name)
{
    m_name = name;
}
...
inline void Uniform_Def::set_semantic(std::string const& semantic)
{
    m_semantic = semantic;
}
inline std::string Uniform_Def::get_semantic() const
{
    return m_semantic;
}
}

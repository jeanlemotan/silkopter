...
namespace video
{
	...
	public:
		Attribute_Def();
		Attribute_Def(String const& name);
		Attribute_Def(String const& name, String const& human_name);

		auto get_human_name() const -> String;
		...
		void set_attribute_name(String const& name);
		auto get_attribute_name() const -> String;
	...
	private:
		String		m_name;
		String		m_human_name;
		String		m_atribute_name;
		Vertex_Declaration::Semantic m_semantic;
		size_t		m_component_count;
		bool		m_is_enabled;
	};

	inline Attribute_Def::Attribute_Def()
		: m_semantic(Vertex_Declaration::Semantic::USER)
		, m_component_count(0)
		, m_is_enabled(false)
	{
		;
	}
	inline Attribute_Def::Attribute_Def(String const& name)
		: m_name(name)
		, m_human_name(name)
		, m_semantic(Vertex_Declaration::Semantic::USER)
		, m_component_count(0)
	...
	inline Attribute_Def::Attribute_Def(String const& name, String const& human_name)
		: m_name(name)
	...
	inline auto Attribute_Def::get_human_name() const -> String
	{
		return m_human_name;
	}
	inline auto Attribute_Def::get_name() const -> String
	{
		return m_name;
	}
	inline void Attribute_Def::set_attribute_name(String const& name)
	{
		size_t ccount = 0;
	...
	inline auto Attribute_Def::get_attribute_name() const -> String
	{

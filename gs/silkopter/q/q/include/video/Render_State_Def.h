...
namespace video
{
	...
	private:
		bool				m_is_blending_locked;
		bool				m_is_culling_locked;
		bool				m_is_deph_locked;
		Render_State		m_default;
	};

	inline Render_State_Def::Render_State_Def()
		: m_is_blending_locked(false)
		, m_is_culling_locked(false)
		, m_is_deph_locked(false)
	{
		;
	}

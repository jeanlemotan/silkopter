...
namespace video
{
	...
	public:
		...
		void set_color_clear_value(math::vec3f const& color);
		auto get_color_clear_value() const -> math::vec3f const&;
	...
	protected:
		...
		void clear(gles::Interface& interf, math::vec3f const& color, float depth, uint32_t mask);
		void bind(gles::Interface& interf, math::vec3f const& color, float depth);
	...
	private:
		...
		math::vec3f m_color_clear_value;

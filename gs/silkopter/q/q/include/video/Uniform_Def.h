...
namespace video
{
	...
	public:
		...
		Uniform_Def();
		Uniform_Def(Uniform_Def const& other);
		Uniform_Def(Uniform_Def&& other);
	...
	inline Uniform_Def::Uniform_Def()
		: m_is_enabled(false)
		, m_precision(Precision::HIGH)
	{
		;
	}
	inline Uniform_Def::Uniform_Def(Uniform_Def const& other)
		: m_name(other.m_name)
	...
	inline Uniform_Def::Uniform_Def(Uniform_Def&& other)

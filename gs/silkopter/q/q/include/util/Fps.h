...
inline Fps::Fps(Fps const& other)
	: m_target_frame_time(other.m_target_frame_time)
...
inline Fps& Fps::operator=(Fps const& other)
{
	m_target_frame_time = other.m_target_frame_time;
	m_last_time = other.m_last_time;
	m_frame_time = other.m_frame_time;

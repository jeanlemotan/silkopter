...
Angular_Velocity_Calibration_Wizard::~Angular_Velocity_Calibration_Wizard()
{
...
void Angular_Velocity_Calibration_Wizard::on_samples_received(std::vector<silk::stream::IAngular_Velocity::Sample> const& samples)
{

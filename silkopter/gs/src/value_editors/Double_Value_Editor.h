...
{
public:
    Double_Value_Editor(const Qualified_Value<ts::IDouble_Value>& qualified_value, std::string const& suffix_str);
...
private:
    ...
    Qualified_Value<ts::IDouble_Value> m_qualified_value;

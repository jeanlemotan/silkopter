...
Double_Value_Editor::Double_Value_Editor(const Qualified_Value<ts::IDouble_Value>& qualified_value, std::string const& editor_str, std::string const& suffix_str)

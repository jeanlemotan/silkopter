...
{
public:
    Optional_Value_Editor(const Qualified_Value<ts::IOptional_Value>& qualified_value, std::string const& suffix_str, std::shared_ptr<Value_Editor_Factory> valueEditorFactory);

...
class Magnetic_Field_Stream_Viewer_Widget : public IStream_Viewer_Widget
{
public:
    Magnetic_Field_Stream_Viewer_Widget(QWidget* parent);
    ~Magnetic_Field_Stream_Viewer_Widget();

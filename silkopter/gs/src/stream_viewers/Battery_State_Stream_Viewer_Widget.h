...
class Battery_State_Stream_Viewer_Widget : public IStream_Viewer_Widget
{
public:
    Battery_State_Stream_Viewer_Widget(QWidget* parent);
    ~Battery_State_Stream_Viewer_Widget();

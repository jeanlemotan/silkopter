...
class Angular_Velocity_Stream_Viewer_Widget : public IStream_Viewer_Widget
{
public:
    Angular_Velocity_Stream_Viewer_Widget(QWidget* parent);
    ~Angular_Velocity_Stream_Viewer_Widget();

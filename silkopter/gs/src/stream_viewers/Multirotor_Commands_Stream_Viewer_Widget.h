...
class Multirotor_Commands_Stream_Viewer_Widget : public IStream_Viewer_Widget
{
public:
    Multirotor_Commands_Stream_Viewer_Widget(QWidget* parent);
    ~Multirotor_Commands_Stream_Viewer_Widget();

...
public:
    ...
    q::util::Signal<void(Mouse_Event)> mouse_press_signal;
    q::util::Signal<void(Mouse_Event)> mouse_release_signal;
    q::util::Signal<void(Mouse_Event)> mouse_move_signal;
    q::util::Signal<void(Mouse_Event)> mouse_wheel_signal;

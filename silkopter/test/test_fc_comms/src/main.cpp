...
std::array<std::string, 3> s_rx_periodic_payloads = { "SLAVE: ABCDEFGHIJ", "SLAVE: KLMNOP", "SLAVE: QRSTUVXYZ" };
std::array<std::string, 3> s_tx_periodic_payloads = { "MASTER: ABCDEFGHIJ", "MASTER: KLMNOP", "MASTER: QRSTUVXYZ" };

std::string s_rx_reliable_payload = { "SLAVE: This is a test string that is long enough to cause multiple packets.\n"
                                      ...
                                      "The end." };
std::string s_tx_reliable_payload = { "MASTER: This is a test string that is long enough to cause multiple packets.\n"
                                      "The second line is here in increase the size.\n"
                                      "There is a third line as well to make the size even longer.\n"
                                      "Four lines are not enough for a decent size.\n"
                                      "Maybe the fifth line will cause the packet to exceed 500 chars?\n"

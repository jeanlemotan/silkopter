...
////////////////////////////////////////////////////////////
    ...
    void Multirotor_Descriptor::Motor::set_thrust_vector(vec3f const& value)
    {
      m_thrust_vector = clamp(value, vec3f(-340282346638528859811704183484516925440.000000f, -340282346638528859811704183484516925440.000000f, -340282346638528859811704183484516925440.000000f), vec3f(340282346638528859811704183484516925440.000000f, 340282346638528859811704183484516925440.000000f, 340282346638528859811704183484516925440.000000f));
    }
    auto Multirotor_Descriptor::Motor::get_thrust_vector() const -> vec3f const& 
    {
...
////////////////////////////////////////////////////////////
  ...
  void MaxSonar_Config::set_direction(vec3f const& value)
  {
    m_direction = clamp(value, vec3f(-340282346638528859811704183484516925440.000000f, -340282346638528859811704183484516925440.000000f, -340282346638528859811704183484516925440.000000f), vec3f(340282346638528859811704183484516925440.000000f, 340282346638528859811704183484516925440.000000f, 340282346638528859811704183484516925440.000000f));
  }
  auto MaxSonar_Config::get_direction() const -> vec3f const& 
  {
    return m_direction;
  }
...
////////////////////////////////////////////////////////////
  ...
  void MPU9250_Config::set_rotation(vec3f const& value)
  {
    m_rotation = clamp(value, vec3f(-180.000000f, -180.000000f, -180.000000f), vec3f(180.000000f, 180.000000f, 180.000000f));
  }
  auto MPU9250_Config::get_rotation() const -> vec3f const& 
  {
    return m_rotation;
  }
...
////////////////////////////////////////////////////////////
    ...
    void Raspicam_Descriptor::Quality::set_resolution(vec2i const& value)
    {
      m_resolution = clamp(value, vec2i(8LL, 8LL), vec2i(1980LL, 1080LL));
    }
    auto Raspicam_Descriptor::Quality::get_resolution() const -> vec2i const& 
    {
      return m_resolution;
    }
...
////////////////////////////////////////////////////////////
  ...
  void SRF01_Config::set_direction(vec3f const& value)
  {
    m_direction = clamp(value, vec3f(-340282346638528859811704183484516925440.000000f, -340282346638528859811704183484516925440.000000f, -340282346638528859811704183484516925440.000000f), vec3f(340282346638528859811704183484516925440.000000f, 340282346638528859811704183484516925440.000000f, 340282346638528859811704183484516925440.000000f));
  }
  auto SRF01_Config::get_direction() const -> vec3f const& 
  {
    return m_direction;
  }
...
////////////////////////////////////////////////////////////
  ...
  void SRF02_Config::set_direction(vec3f const& value)
  {
    m_direction = clamp(value, vec3f(-340282346638528859811704183484516925440.000000f, -340282346638528859811704183484516925440.000000f, -340282346638528859811704183484516925440.000000f), vec3f(340282346638528859811704183484516925440.000000f, 340282346638528859811704183484516925440.000000f, 340282346638528859811704183484516925440.000000f));
  }
  auto SRF02_Config::get_direction() const -> vec3f const& 
  {
    return m_direction;
  }

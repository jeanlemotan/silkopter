...
////////////////////////////////////////////////////////////
      void Multirotor_Brain_Config::Horizontal::Separate_Rate_PIDs::set_x_pid(PID_Controller_Descriptor const& value)
      {
        m_x_pid = value;
      }
      void Multirotor_Brain_Config::Horizontal::Separate_Rate_PIDs::set_x_pid(PID_Controller_Descriptor&& value)
      {
        m_x_pid = std::move(value);
      }
      auto Multirotor_Brain_Config::Horizontal::Separate_Rate_PIDs::get_x_pid() const -> PID_Controller_Descriptor const& 
      {
        return m_x_pid;
      }

      auto Multirotor_Brain_Config::Horizontal::Separate_Rate_PIDs::get_x_pid() -> PID_Controller_Descriptor& 
      {
        return m_x_pid;
      }

////////////////////////////////////////////////////////////
      void Multirotor_Brain_Config::Horizontal::Separate_Rate_PIDs::set_y_pid(PID_Controller_Descriptor const& value)
      {
        m_y_pid = value;
      }
      void Multirotor_Brain_Config::Horizontal::Separate_Rate_PIDs::set_y_pid(PID_Controller_Descriptor&& value)
      {
        m_y_pid = std::move(value);
      }
      auto Multirotor_Brain_Config::Horizontal::Separate_Rate_PIDs::get_y_pid() const -> PID_Controller_Descriptor const& 
      {
        return m_y_pid;
      }

      auto Multirotor_Brain_Config::Horizontal::Separate_Rate_PIDs::get_y_pid() -> PID_Controller_Descriptor& 
      {
        return m_y_pid;
      }
...
////////////////////////////////////////////////////////////
    void Multirotor_Brain_Config::Horizontal::set_rate_pids(boost::variant<Combined_Rate_PIDs,Separate_Rate_PIDs> const& value)
    {
      m_rate_pids = value;
    }
    void Multirotor_Brain_Config::Horizontal::set_rate_pids(boost::variant<Combined_Rate_PIDs,Separate_Rate_PIDs>&& value)
    {
      m_rate_pids = std::move(value);
    }
    auto Multirotor_Brain_Config::Horizontal::get_rate_pids() const -> boost::variant<Combined_Rate_PIDs,Separate_Rate_PIDs> const& 
    {
      return m_rate_pids;
    }

    auto Multirotor_Brain_Config::Horizontal::get_rate_pids() -> boost::variant<Combined_Rate_PIDs,Separate_Rate_PIDs>& 
    {
      return m_rate_pids;
    }
...
////////////////////////////////////////////////////////////
    void Multirotor_Brain_Config::Yaw::set_rate_pid(PID_Controller_Descriptor const& value)
    {
      m_rate_pid = value;
    }
    void Multirotor_Brain_Config::Yaw::set_rate_pid(PID_Controller_Descriptor&& value)
    {
      m_rate_pid = std::move(value);
    }
    auto Multirotor_Brain_Config::Yaw::get_rate_pid() const -> PID_Controller_Descriptor const& 
    {
      return m_rate_pid;
    }

    auto Multirotor_Brain_Config::Yaw::get_rate_pid() -> PID_Controller_Descriptor& 
    {
      return m_rate_pid;
    }
...
ts::Result<void> deserialize(Poly<INode_Message>& value, ts::sz::Value const& sz_value)
{
  ...
  else if (path == "::Multirotor_Simulator_Freeze_Message")
  {
    value = Poly<INode_Message>(new Multirotor_Simulator_Freeze_Message());
    return deserialize((Multirotor_Simulator_Freeze_Message&)*value, *value_sz_value);
  }
...
ts::sz::Value serialize(Poly<INode_Message> const& value)
{
  ...
  else if (typeid(*value) == typeid(Multirotor_Simulator_Freeze_Message))
  {
    sz_value.reserve_object_members(2);
    sz_value.add_object_member("type", "::Multirotor_Simulator_Freeze_Message");
    sz_value.add_object_member("value", serialize((Multirotor_Simulator_Freeze_Message&)*value));
    return std::move(sz_value);
  }
...
ts::Result<void> deserialize(Multirotor_Brain_Config::Horizontal& value, ts::sz::Value const& sz_value)
{
  ...
  {
    auto const* member_sz_value = sz_value.find_object_member_by_name("rate_pids");
    if (!member_sz_value) { return ts::Error("Cannot find member value 'rate_pids'"); }
    std::remove_cv<std::remove_reference<decltype(value.get_rate_pids())>::type>::type v;
    auto result = deserialize(v, *member_sz_value);
    if (result != ts::success) { return result; }
    value.set_rate_pids(std::move(v));
  }
  {
...
ts::sz::Value serialize(Multirotor_Brain_Config::Horizontal const& value)
{
  ...
  sz_value.add_object_member("rate_pids", serialize(value.get_rate_pids()));
...
ts::Result<void> deserialize(Multirotor_Brain_Config::Yaw& value, ts::sz::Value const& sz_value)
{
  ...
  {
    auto const* member_sz_value = sz_value.find_object_member_by_name("rate_pid");
    if (!member_sz_value) { return ts::Error("Cannot find member value 'rate_pid'"); }
    std::remove_cv<std::remove_reference<decltype(value.get_rate_pid())>::type>::type v;
    auto result = deserialize(v, *member_sz_value);
    if (result != ts::success) { return result; }
    value.set_rate_pid(std::move(v));
  }
  return ts::success;
}
ts::sz::Value serialize(Multirotor_Brain_Config::Yaw const& value)
{
  ...
  sz_value.reserve_object_members(2);
  sz_value.add_object_member("max_rate_deg", serialize(value.get_max_rate_deg()));
  sz_value.add_object_member("rate_pid", serialize(value.get_rate_pid()));
  return sz_value;
}
...
ts::Result<void> deserialize(boost::variant<Multirotor_Brain_Config::Horizontal::Combined_Rate_PIDs,Multirotor_Brain_Config::Horizontal::Separate_Rate_PIDs>& value, ts::sz::Value const& sz_value)
{
  ...
  std::string const& path = type_sz_value->get_as_string();
  if (false) { return ts::Error(""); } //this is here just to have the next items with 'else if'
  else if (path == "::Multirotor_Brain_Config::Horizontal::Combined_Rate_PIDs")
  {
    value = Multirotor_Brain_Config::Horizontal::Combined_Rate_PIDs();
    auto result = deserialize(boost::get<Multirotor_Brain_Config::Horizontal::Combined_Rate_PIDs>(value), *value_sz_value);
    if (result != ts::success) { return result; }
  }
  else if (path == "::Multirotor_Brain_Config::Horizontal::Separate_Rate_PIDs")
  {
    value = Multirotor_Brain_Config::Horizontal::Separate_Rate_PIDs();
    auto result = deserialize(boost::get<Multirotor_Brain_Config::Horizontal::Separate_Rate_PIDs>(value), *value_sz_value);
    if (result != ts::success) { return result; }
  }
  else { return ts::Error("Cannot find type '" + path + "' when deserializing"); }
  return ts::success;
...
ts::sz::Value serialize(boost::variant<Multirotor_Brain_Config::Horizontal::Combined_Rate_PIDs,Multirotor_Brain_Config::Horizontal::Separate_Rate_PIDs> const& value)
{
  ts::sz::Value sz_value(ts::sz::Value::Type::OBJECT);
  if (false) { return ts::sz::Value(); } //this is here just to have the next items with 'else if'
  else if (auto* v = boost::get<Multirotor_Brain_Config::Horizontal::Combined_Rate_PIDs>(&value))
  {
    sz_value.reserve_object_members(2);
    sz_value.add_object_member("type", "::Multirotor_Brain_Config::Horizontal::Combined_Rate_PIDs");
    sz_value.add_object_member("value", serialize(*v));
    return std::move(sz_value);
  }
  else if (auto* v = boost::get<Multirotor_Brain_Config::Horizontal::Separate_Rate_PIDs>(&value))
  {
    sz_value.reserve_object_members(2);
    sz_value.add_object_member("type", "::Multirotor_Brain_Config::Horizontal::Separate_Rate_PIDs");
    sz_value.add_object_member("value", serialize(*v));
    return std::move(sz_value);
  }
  else { TS_ASSERT(false); return ts::sz::Value(); }

...
auto MS5611::get_barometer() -> node::IBarometer&
{
    return m_barometer;
}
auto MS5611::get_thermometer() -> node::IThermometer&
{
...
auto MS5611::init(node::II2C* bus, Init_Params const& params) -> bool
{
    m_i2c = bus;
    m_spi = nullptr;
    return init(params);
}
auto MS5611::init(node::ISPI* bus, Init_Params const& params) -> bool
{
    m_spi = bus;
    m_i2c = nullptr;
    return init(params);

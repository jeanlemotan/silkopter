...
auto MPU9250::get_accelerometer() -> node::IAccelerometer&
{
    return m_accelerometer;
}
auto MPU9250::get_gyroscope() -> node::IGyroscope&
{
    return m_gyroscope;
}
auto MPU9250::get_compass() -> node::ICompass&
{
    return m_compass;
}
auto MPU9250::get_thermometer() -> node::IThermometer&
{
...
auto MPU9250::init(node::II2C* i2c, Init_Params const& params) -> bool
{
    m_i2c = i2c;
    m_spi = nullptr;
    return init(params);
...
auto MPU9250::init(node::ISPI* spi, Init_Params const& params) -> bool
{
    m_spi = spi;
    m_i2c = nullptr;
    return init(params);

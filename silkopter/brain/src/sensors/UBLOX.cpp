...
auto UBLOX::init(buses::II2C* bus, Params const& params) -> bool
{
    m_i2c = bus;
    m_spi = nullptr;
    m_uart = nullptr;
...
auto UBLOX::init(buses::ISPI* bus, Params const& params) -> bool
{
    m_spi = bus;
    m_i2c = nullptr;
    m_uart = nullptr;
...
auto UBLOX::init(buses::IUART* bus, Params const& params) -> bool
{
    m_spi = nullptr;
    m_i2c = nullptr;
    m_uart = bus;

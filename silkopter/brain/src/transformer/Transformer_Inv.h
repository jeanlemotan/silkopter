...
template<class In_Stream_t, class Out_Stream_t, class Frame_Stream_t>
ts::Result<void> Transformer_Inv<In_Stream_t, Out_Stream_t, Frame_Stream_t>::set_input_stream_path(size_t idx, std::string const& path)
{
...
template<class In_Stream_t, class Out_Stream_t, class Frame_Stream_t>
ts::Result<void> Transformer_Inv<In_Stream_t, Out_Stream_t, Frame_Stream_t>::start(Clock::time_point tp)
{

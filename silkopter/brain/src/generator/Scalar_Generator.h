...
template<class Stream_t>
ts::Result<void> Scalar_Generator<Stream_t>::start(Clock::time_point tp)
{
...
template<class Stream_t>
ts::Result<std::shared_ptr<messages::INode_Message>> Scalar_Generator<Stream_t>::send_message(messages::INode_Message const& message)
{

...
////////////////////////////////////////////////////////////
    ...
    {
      m_rc_xtal_ajdustment = clamp(value, rc_xtal_adjustment_t(-1.000000f), rc_xtal_adjustment_t(1.000000f));
    }
    void IUAV_Descriptor::Comms::set_rc_xtal_ajdustment(rc_xtal_adjustment_t&& value)
    {
      m_rc_xtal_ajdustment = clamp(std::move(value), rc_xtal_adjustment_t(-1.000000f), rc_xtal_adjustment_t(1.000000f));
    }

...
template<class Stream_t>
ts::Result<void> Vec3_Generator<Stream_t>::start(Clock::time_point tp)
{
...
template<class Stream_t>
ts::Result<std::shared_ptr<messages::INode_Message>> Vec3_Generator<Stream_t>::send_message(messages::INode_Message const& message)
{
...
auto Vec3_Generator<Stream_t>::get_inputs() const -> std::vector<Input>
{
    ...
    {{
        { stream::IFloat::TYPE, m_descriptor->get_rate(), "x_modulation", m_modulation_stream_paths[0] },
        { stream::IFloat::TYPE, m_descriptor->get_rate(), "y_modulation", m_modulation_stream_paths[1] },
        { stream::IFloat::TYPE, m_descriptor->get_rate(), "z_modulation", m_modulation_stream_paths[2] }
    }};
    return inputs;
}
template<class Stream_t>

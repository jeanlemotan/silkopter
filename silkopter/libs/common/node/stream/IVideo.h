...
template<> inline void serialize(Buffer_t& buffer, silk::node::stream::IVideo::Value const& value, size_t& off)
{
...
template<> inline auto deserialize(Buffer_t const& buffer, silk::node::stream::IVideo::Value& value, size_t& off) -> bool
{
    uint32_t size = 0;

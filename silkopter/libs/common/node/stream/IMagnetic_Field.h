...
class IENU_Magnetic_Field : public IStream
{
    DEFINE_RTTI_CLASS(IENU_Magnetic_Field, IStream);
public:
    typedef math::vec3f       Value; //??
    typedef stream::Sample<Value>     Sample;
    virtual auto get_samples() const -> std::vector<Sample> const& = 0;
...
class IECEF_Magnetic_Field : public IStream
{
    DEFINE_RTTI_CLASS(IECEF_Magnetic_Field, IStream);
public:
    typedef math::vec3f       Value; //??
    typedef stream::Sample<Value>     Sample;
    virtual auto get_samples() const -> std::vector<Sample> const& = 0;

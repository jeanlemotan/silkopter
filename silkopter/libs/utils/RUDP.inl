...
{
    //socket interface
    class RUDP_Asio_Socket : public RUDP_Socket
    {
    public:
        RUDP_Asio_Socket(boost::asio::io_service& io_service)
            : m_socket(io_service)
        {
            m_buffer.resize(100 * 1024);
            m_asio_send_callback = boost::bind(&RUDP_Asio_Socket::handle_send, this, boost::asio::placeholders::error, boost::asio::placeholders::bytes_transferred);
            m_asio_receive_callback = boost::bind(&RUDP_Asio_Socket::handle_receive, this, boost::asio::placeholders::error, boost::asio::placeholders::bytes_transferred);
        }
...
//                    QLOGI("{}// allocated: {} / {}", m_pool.get(), item, x_new);
    ...
    inline RUDP::RUDP(RUDP_Socket& socket)
        : m_socket(socket)
    {
...
//        hsz =sizeof(Ping_Header);
        ...
        m_socket.receive_callback = std::bind(&RUDP::handle_receive, this, std::placeholders::_1, std::placeholders::_2);
        m_socket.send_callback = std::bind(&RUDP::handle_send, this, std::placeholders::_1);
...
//        }
    ...
    inline void RUDP::handle_send(RUDP_Socket::Result)
    {
...
//            }
    ...
    inline void RUDP::handle_receive(uint8_t const* data, size_t size)
    {
        if (size > 0)
        {

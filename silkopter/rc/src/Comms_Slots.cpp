...
Comms_Slots::Comms_Slots(silk::Comms& comms, ts::Type_System& ts)
    : m_comms(comms)
    , m_ts(ts)
{
    ...
    m_connections.uav_descriptor_received = m_comms.sig_uav_descriptor_received.connect(std::bind(&Comms_Slots::slot_uav_descriptor_received, this, std::placeholders::_1));
}

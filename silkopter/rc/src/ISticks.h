...
public:
    ...
    virtual void set_yaw_calibration(float min, float center, float max, float deadband) = 0;

    virtual float get_raw_pitch(Raw_Type raw_type) const = 0;
    virtual float get_pitch() const = 0;
    virtual void set_pitch_calibration(float min, float center, float max, float deadband) = 0;

    virtual float get_raw_roll(Raw_Type raw_type) const = 0;
    virtual float get_roll() const = 0;
    virtual void set_roll_calibration(float min, float center, float max, float deadband) = 0;
    ...
    virtual void set_throttle_calibration(float min, float center, float max, float deadband) = 0;

...
public:
  ...
  vector(size_type __n, const _Tp& _value,
         const allocator_type& __a = allocator_type()) 
    : _Base(__n, __a)
    { _M_finish = uninitialized_fill_n(_M_start, __n, _value); }
  ...
  void _M_initialize_aux(_Integer __n, _Integer _value, __true_type) {
    _M_start = _M_allocate(__n);
    _M_end_of_storage = _M_start + __n; 
    _M_finish = uninitialized_fill_n(_M_start, __n, _value);
  }

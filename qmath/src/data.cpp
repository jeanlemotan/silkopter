...
// DEFINE_CONSTANTS(float)
// DEFINE_CONSTANTS(double)
// DEFINE_CONSTANTS(uint8_t)
// DEFINE_CONSTANTS(uint16_t)
// DEFINE_CONSTANTS(uint32_t)
// DEFINE_CONSTANTS(int8_t)
// DEFINE_CONSTANTS(int16_t)
// DEFINE_CONSTANTS(int32_t)

...
template<typename T> inline vec3<T> floor(vec3<T> const& x)
{
    return vec3<T>(floor(x.x), floor(x.y), floor(x.z));
}
template<typename T> inline vec4<T> floor(vec4<T> const& x)
{
...
template<typename T> inline vec3<T> ceil(vec3<T> const& x)
{
    return vec3<T>(ceil(x.x), ceil(x.y), ceil(x.z));
}
template<typename T> inline vec4<T> ceil(vec4<T> const& x)
{
...
template<typename T> inline vec3<T> fract(vec3<T> const& x)
{
...
template<typename T> inline T round(T x); //no implementation
...
template<typename T> inline vec2<T> round(vec2<T> const& x)
{
    return vec2<T>(round(x.x), round(x.y));
}
template<typename T> inline vec3<T> round(vec3<T> const& x)
{
    return vec3<T>(round(x.x), round(x.y), round(x.z));
}
template<typename T> inline vec4<T> round(vec4<T> const& x)
{
...
//rounds to the closest integer
template<typename T> inline T round(T x, uint8_t decimals); //no implementation
...
template<typename T> inline vec2<T> round(vec2<T> const& x, uint8_t decimals)
{
    return vec2<T>(round(x.x, decimals), round(x.y, decimals));
}
template<typename T> inline vec3<T> round(vec3<T> const& x, uint8_t decimals)
{
    return vec3<T>(round(x.x, decimals), round(x.y, decimals), round(x.z, decimals));
}
template<typename T> inline vec4<T> round(vec4<T> const& x, uint8_t decimals)
{

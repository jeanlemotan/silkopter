...
#define dynamic_murmurhash_seed(str, seed) q::util::MurmurHash2(str, strlen(str), seed)
#define static_murmurhash_seed(str, seed) q::util::MURMUR<sizeof(str)-1>(seed, str)

#define dynamic_murmurhash(str) q::util::MurmurHash2(str, strlen(str), 0)
#define static_murmurhash(str) q::util::MURMUR<sizeof(str)-1>(0, str)

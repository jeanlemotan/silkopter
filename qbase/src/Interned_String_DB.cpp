...
size_t String_DB_Map::collect_garbage()
{
	...
	for (size_t i = 0; i < m_cell_pool.size(); i++)
	{
		...
		for (size_t j = 0; j < pool->used_cell_count; j++)
		{
            ...
            //if a cell has a nullptr counter, it was part of a family and it used to point to the counterData of the head
            //since it's nullptr, the head was released previously

...
#include <HAL/Clock.h>
#include <HAL/RC_In.h>
#include <HAL/PWM_Out.h>
#include <Format/Format.h>

int main(void)
{
	hal::uart0.begin(115200);
	hal::pwm_out::set_frequencies(50);
	hal::pwm_out::set_all_enabled(true);
    ...
    while(1)
    {
		...
		hal::rc_in::get_channels(channels, 8);
		...
		hal::pwm_out::set_all_channels(value);

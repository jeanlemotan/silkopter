...
namespace detail
{
	...
	uint8_t get_base_10_digit_count(uint64_t v)
	{
		if (v < 10) return 1;
		if (v < 100) return 2;
		if (v < 1000) return 3;
	...
	uint8_t get_base_10_digit_count(uint8_t v)
	{
		if (v < 100) 
		{
			return (v < 10) ? 1 : 2;
	...
	uint8_t get_base_10_digit_count(uint16_t v)
	{
		if (v < 10000)
		{
			if (v < 1000)
	...
	uint8_t get_base_10_digit_count(uint32_t v)
	{
		if (v < 100000)
		{
			if (v < 10000)
